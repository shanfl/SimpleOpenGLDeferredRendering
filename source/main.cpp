                     ...
                     int       nCmdShow) 
{
	...
	hWnd = CreateWindowEx(dwExStyle, "DeferredRenderingClass",  "Deferred rendering tutorial", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, width, height, NULL, NULL, hInstance, NULL);
